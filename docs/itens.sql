...
values
('Itens chave', 1, curdate(), true),
('Não consumíveis', 1, curdate(), true),
('Consumíveis', 1, curdate(), true);

insert into info (nomeInfo, textoDaInfo, idCategoria, idSubCategoria)
values
('Itens chave', 'Itens importantes não descartáveis.', 1, 1),
('Não consumíveis', 'Itens descartáveis que não são utilizáveis.', 1, 2),
('onsumíveis', 'itens descartáveis uliziváveis.', 1, 3);
